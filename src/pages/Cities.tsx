      ...
      <div className="min-h-screen bg-background">
        <div className="bg-gradient-hero py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-primary-foreground/80 max-w-2xl mx-auto">
              We deliver across Gujarat. Select your city to explore restaurants and dishes available in your area.
            </p>
          </div>
        </div>
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-muted-foreground">
                        ...
                        <span>{city.restaurant_count} Restaurants</span>
                      </div>
        ...
        <div className="container mx-auto px-4 pb-16">
          <div className="bg-card rounded-2xl p-8 shadow-card">
            <h2 className="font-display text-2xl font-bold text-foreground mb-4 text-center">Gujarat Delivery Coverage</h2>
            <div className="aspect-video rounded-xl overflow-hidden">
              <iframe title="Gujarat Delivery Map" src="https://www.openstreetmap.org/export/embed.html?bbox=68.5%2C20.0%2C75.0%2C24.5&layer=mapnik&marker=22.3%2C72.0" className="w-full h-full border-0" loading="lazy" />
            </div>
            <p className="text-sm text-muted-foreground mt-4 text-center">
              Currently delivering in: {cities.map(c => c.name).join(', ') || 'Loading...'}
            </p>
          </div>
        </div>
      </div>
