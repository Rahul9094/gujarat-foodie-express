            ...
            {cityRestaurants.map((restaurant, index) => (
              ...
              >
                ...
                <div className="p-3 sm:p-4">
                  <h3 className="font-display text-base sm:text-lg font-semibold text-foreground mb-1 line-clamp-1">
                    {restaurant.name}
                  </h3>
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-muted-foreground hidden sm:inline">({restaurant.reviewCount})</span>
                    </div>
                  ...
                  <div className="mt-2 sm:mt-3 flex items-center justify-between">
                    <span className="text-muted-foreground text-xs sm:text-sm">{restaurant.priceRange}</span>
